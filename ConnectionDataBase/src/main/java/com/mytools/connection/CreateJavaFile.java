...
//
//	private Map<String, String> analysisDataType(ResultSet rs) throws SQLException {
...
//				} else {
//					map.put(rs.getString(1), typeValue + "," + rs.getString("ColumnDescription"));
//				}
//
//			} else {
...
//				JavaFileTemple.setPrimaryKey(primaryKey);
