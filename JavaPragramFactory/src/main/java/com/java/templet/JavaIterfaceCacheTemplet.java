...
public class JavaIterfaceCacheTemplet extends JavaFileTempletBase {
	...
	public boolean analysisDataConntent(String packag, String importJar, String className, String beanPackage,
		...
		setInterfaceCacheTemplate(className);
		context.append(
				super.javaFileInterfaceCacheHead(packag, importJar, super.getPrefix() + className + super.getSuffix()));
		context.append(super.interfaceMethod(super.DELETE,className, beanPackage));
		context.append(super.interfaceMethod(super.UPDATECACHEID,className,beanPackage));
		context.append(super.interfaceMethod(super.SELECTBYID,className,beanPackage));
		context.append(super.interfaceMethod(super.UPDATECACHEALL, className));
