...
/**
	...
	* @date 创建时间：2016年7月28日 下午2:28:44 
	* 根据包名查询 所有的class 文件  获得当前的绝对路径
	*  
	*/
...
//		getClassPath("D:/tomcat/apache-tomcat-7.0.69-windows-i64/apache-tomcat-7.0.69/wtpwebapps/Booss-Template/WEB-INF/classes/com/mantoto/cache/config");
//	}
//	
	...
	System.err.println("jar类型的扫描");
	 ...
	 /**
	   ...
	   public  static StringBuffer getRootPath() {
			StringBuffer path = new  StringBuffer(FindClasses.class.getResource("").getPath());
